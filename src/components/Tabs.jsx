...
export default function IconLabelTabs() {
    ...
    return (
        <div className='flex flex-col items-center px-48 py-4 mx-5 my-5 bg-lime-gr rounded-lg'>
            ...
            <Box>
                ...
                >
                    <Tab
                        ...
                        id='0'
                        icon={<img src={ObesityIcon} alt="Obesitas Icon" style={{ width: '40px', height: '40px' }} />}
                        label="Obesitas"
                        sx={{
                    ...
                    <Tab
                        id='1'
                        icon={<img src={StrokeIcon} alt="Stroke Icon" style={{ width: '40px', height: '40px' }} />}
                        label="Stroke"
                        sx={{
                    ...
                    <Tab
                        id='2'
                        icon={<img src={HypertensionIcon} alt="Hipertensi Icon" style={{ width: '40px', height: '40px' }} />}
                        label="Hipertensi"
                        sx={{
                    ...
                    <Tab
                        id='3'
                        icon={<img src={KidneyFailureIcon} alt="Gagal Ginjal Icon" style={{ width: '40px', height: '40px' }} />}
                        label="Gagal Ginjal"
                        sx={{
                    ...
                    <Tab
                        id='4'
                        icon={<img src={OsteoIcon} alt="Osteoporosis Icon" style={{ width: '40px', height: '40px' }} />}
                        label="Osteoporosis"
                        sx={{
                    ...
                    {value === 2 && (
                        ...
                        <Box sx={{ display: 'flex' }} data-aos="zoom-in">
                            ...
                            <Box sx={{ flex: 1, paddingRight: '20px' }}>
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla sed tortor quis neque accumsan fermentum. Ut a elementum ex. Maecenas luctus nisl a felis placerat.</p>
