  ...
  return (
    ...
    >
      <div className="lg:w-1/2 flex flex-col justify-center items-center">
        <div className="w-9/12 bg-[#A0DEFF] lg:bg-white p-10 lg:mb-20 mb-10"data-aos="fade-right">
          <h2 className="lg:text-3xl text-2xl poppins-bold">Kesehatan Fisik</h2>
          <p className="lg:text-xl text-lg">{kesehatanFisik}</p>
        </div>
        <div className=" bg-lime-gr lg:bg-[#A0DEFF] w-9/12 p-10" data-aos="fade-right">
          <h2 className="lg:text-3xl text-2xl poppins-bold">Aktivitas Fisik</h2>
          <p className="lg:text-xl text-lg">{aktivitasFisik}</p>
        </div>
      </div>
      <div className="lg:w-1/2 flex justify-center items-center lg:mb-0 mb-14" data-aos="fade-left">
