  ...
  return (
    ...
    >
      <div className="lg:w-1/2 flex flex-col justify-center items-center">
        <div className="w-9/12 bg-[#A0DEFF] lg:bg-white p-10 mb-10">
          <h2 className="lg:text-3xl poppins-bold">Kesehatan Fisik</h2>
          <p className="text-lg">{kesehatanFisik}</p>
        </div>
        <div className=" bg-lime-gr lg:bg-[#A0DEFF] w-9/12 p-10">
          <h2 className="lg:text-3xl poppins-bold">Aktivitas Fisik</h2>
          <p className="text-lg">{aktivitasFisik}</p>
        </div>
      </div>
